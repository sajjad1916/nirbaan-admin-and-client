                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">The max number of days customers are allowed to
                                schedule an order</p>
                        </div>
                        {{-- schedule order time --}}
                        <div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Hours from close time that customer still allow to
                                book for</p>
                        </div>
