        ...
        <x-modal-lg confirmText="{{ __('Save') }}" action="save" :clickAway="false">
            ...
            <div class="grid items-center grid-cols-2 space-x-4">
                ...
                <x-checkbox title="{{ __('Auto Accept Order') }}" name="auto_accept"
                    description="{{ __('System will automatic change pending order to preparing') }}" :defer="false" />
            </div>
            <hr class="mt-4"/>
            <div class="grid grid-cols-2 space-x-4">
            ...
            <div class="grid grid-cols-2 space-x-4">
                    <x-input 
                        title="{{ __('System Commission(%)') }}" 
                        name="commission"
                        {{--  disable="{{ $use_subscription ? true:false }}"  --}}
                     />
    ...
    <div x-data="{ open: @entangle('showEdit') }">
        <x-modal-lg confirmText="{{ __('Update') }}" action="update" :clickAway="false">
            ...
            <div
                class="block"
                >
                <div class="block grid grid-cols-2 space-x-4">
                    <x-input title="{{ __('Minimum Order Amount') }}" name="min_order" />
                    <x-input title="{{ __('Maximum Order Amount') }}" name="max_order" />
                </div>
                <div class="grid grid-cols-2 space-x-4">
