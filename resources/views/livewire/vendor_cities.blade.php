    ...
    <div>
        ...
        <div x-data="{ open: @entangle('showCreate') }">
            <x-modal confirmText="{{ __('Save') }}" action="save">
                ...
                <x-select title="{{ __('Country') }}" :options='$countries' name="country_id" :defer="false" onchange="countryChanged" />
                <x-select title="{{ __('State') }}" :options='$states' name="state_id" :defer="false" onchange="stateChanged" />
